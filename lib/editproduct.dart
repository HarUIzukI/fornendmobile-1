...
class _EditProductState extends State<EditProduct> {
  ...
  Future<void> _fetchProductDetails(int productId) async {
    ...
    var url = Uri.parse(
        'https://642021156.pungpingcoding.online/api/products/$productId');
    ...
    if (response.statusCode == 200) {
      ...
      int productType = payload[
          'product_type']; // Assuming 'product_type' is the field name for product type
      setState(() {
        _nameController.text = productName;
        _name = productName; // Initialize _name with retrieved value
        _priceController.text = price.toString();
        _price = price.toInt(); // Initialize _price with retrieved value
  ...
  Future<void> _submitFormData() async {
    ...
    var url = Uri.parse(
        'https://642021156.pungpingcoding.online/api/products/${widget.productId}');
