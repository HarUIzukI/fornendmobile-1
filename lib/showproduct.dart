...
class _ShowProductPageState extends State<ShowProductPage> {
  ...
  Future<void> _fetchProducts() async {
    ...
    var url = Uri.parse('https://642021156.pungpingcoding.online/api/product');
  ...
  Future<void> _deleteProduct(int id) async {
    var url =
        Uri.parse('https://642021156.pungpingcoding.online/api/products/$id');
  ...
  Future<void> _logout() async {
    ...
    var logoutUrl =
        Uri.parse('https://642021156.pungpingcoding.online/api/logout');
...
// import 'package:lab10/addproduct.dart';
// import 'package:lab10/LoginPage.dart';
// import 'package:http/http.dart' as http;
// import 'package:flutter/material.dart';
// import 'package:shared_preferences/shared_preferences.dart';
...
// class ShowProductPage extends StatefulWidget {
//   @override
//   State<ShowProductPage> createState() => _productpagesState();
// }

// class _productpagesState extends State<ShowProductPage> {
...
//     String token = prefs.getString('token') ?? '';
//     var url =
//         Uri.parse('https://642021156.pungpingcoding.online/api/product/$id');
